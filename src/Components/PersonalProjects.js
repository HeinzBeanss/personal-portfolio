...
const PersonalProjects = () => {
  useEffect(() => {
    ...
    window.addEventListener("scroll", () => {
      ...
      if (
        primarytop < window.innerHeight - 200 &&
        primaryproject.classList.contains("notonpage")
      ) {
      ...
      projects.forEach((project) => {
        ...
        if (
          ...
          project.classList.contains("notonpage")
        ) {
  ...
  return (
    <div className="PersonalProjects">
      ...
      <p className="personalprojectdesc">
        A showcase of several projects I've created using a variety of
        technologies.
      </p>
      ...
      <div className="primaryproject">
        <div className="primaryprojectinfo left">
          ...
          <p className="projectdesclarge">
            BeeBuddies is a social media platform crafted with a unique
            front-end client built on React, complemented by a back-end API
            following RESTful practices. This dynamic combination utilizes
            NodeJS and Express, coupled with MongoDB for database storage.
            Embracing its distinct identity, the platform boasts a custom design
            and captivating typeface. The user-friendly interface welcomes
            everyone to easily create an account and engage with others as they
            please. Embracing versatility, BeeBuddies adapts to all screen
            layouts, ensuring an optimal experience across desktop, tablet, and
            mobile devices.
          </p>

          <p className="projectdesclarge">
            If you want to explore without the effort of creating an account,
            please utilise the <i>continue as guest</i> feature on the login
            page.
          </p>

          <p className="projectstacklarge">
            Created using React, NodeJS, and MongoDB
          </p>
        </div>
        <div class="beebuddiesmedia">
          <div className="gifbackgroundprimary">
            <a
              href="https://heinzbeanss.github.io/beebuddies/#/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                className="beebuddiessbig gif"
          ...
          <div className="gifbackgroundsecondary">
            ...
            >
              <img
                className="beebuddiessmall gif"
                srcSet={`${beebuddiessmall} 600w, ${beebuddiessmall} 700w`}
                sizes="(max-width: 300px) 480px, 700px"
                src={beebuddiessmall}
                alt="beebuddies"
              ></img>
            </a>
      ...
      <div className="projectarea">
        <div className="project instagram">
          <div className="gifbackground">
            <a
              href="https://heinzbeanss.github.io/instagram/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
          ...
          <div className="projectinfo right">
            ...
            <p className="projectdesc">
              A clone of the popular social media platform Instagram, the goal
              here was to achieve around 80% accuracy of the real website. Using
              React for the front end and Firebase for the backend, users can
              create an account, upload their own posts alongside captions, edit
              their profile picture and description, as well as follow and like
              other users and their posts respectively.
            </p>
        ...
        <div className="project battleship">
          <div className="projectinfo left">
            ...
            <p className="projectdesc">
              A simple version of the popular strategy-type guessing game
              Battleship, players can place their shapes ranging from different
              sizes and orientations. The user then takes turns against an easy,
              however, not completely clueless computer in a competitive battle
              in which the first player to hit all the other's ships will be
          ...
          <div className="gifbackground">
            <a
              href="https://heinzbeanss.github.io/battleship/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
        ...
        <div className="project shoppingcart">
          <div className="gifbackground">
            <a
              href="https://heinzbeanss.github.io/shopping-cart/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
          ...
          <div className="projectinfo right">
            ...
            <p className="projectdesc">
              A mockup of a card-selling store page alongside a functioning cart
              where the user can update the contents of their cart before
              heading to the checkout. The dynamically designed grid system
              responds perfectly to a multitude of devices ranging in
              resolution.
            </p>
