...
const Skillset = () => {
  ...
  const [skillnameFront, setSkillnameFront] = useState("ReactJS");
  const [skillnameBack, setSkillnameBack] = useState("NodeJS");
  const [skillnameOther, setSkillnameOther] = useState("Git");

  const changeSkillNameFront = (e) => {
    setSkillnameFront(e.target.getAttribute("alt"));
  };

  const changeSkillNameBack = (e) => {
    setSkillnameBack(e.target.getAttribute("alt"));
  };

  const changeSkillNameOther = (e) => {
    setSkillnameOther(e.target.getAttribute("alt"));
  };

  const [currentlyworkingonskill, setCurrentlyworkingonskill] =
    useState("Node.Js");
  const [currentlyWorkingOnArray, setCurrentlyWorkingOnArray] = useState([
    {
      name: "PHP",
      image: (
        <svg className={`PHP slideshowimage`} alt="PHP" viewBox="0 0 128 128">
          <path
            fill="#6181B6"
    ...
    },
    {
      ...
      image: (
        <svg
          className={`Laravel slideshowimage`}
          alt="Laravel"
          viewBox="0 0 128 128"
        >
          <path
  ...
  const frontendSkillsSet =
    deviceWidth <= 600 ? (
      <div className="skillscontainer">
        ...
        >
          <img
            className="skillsetlogo javascript"
            src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg"
            onMouseOver={changeSkillNameFront}
            alt="JavaScript"
          />
        </a>
        ...
        >
          <img
            className="skillsetlogo reactjs"
  ...
  const backendSkillsSet =
    deviceWidth <= 600 ? (
      <div className="skillscontainer">
        ...
        >
          <img
            className="skillsetlogo node"
            src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg"
            onMouseOver={changeSkillNameBack}
            alt="NodeJS"
          />
        </a>
        ...
        >
          <img
            className="skillsetlogo Express"
  ...
  const otherSkillsSet =
    deviceWidth <= 600 ? (
      <div className="skillscontainer">
        ...
        >
          <img
            className="skillsetlogo git"
            src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg"
            onMouseOver={changeSkillNameOther}
            alt="Git"
          />
        </a>
        ...
        >
          <img
            className="skillsetlogo webpack"
        ...
        >
          <img
            className="skillsetlogo photoshop"
        ...
        >
          <img
            className="skillsetlogo illustrator"
  ...
  return (
    <div className="Skillset">
      ...
      <p className="skillsetdescmain">
        Langues, software, and other technlogies I'm experienced with.
      </p>

      <div class="skillsectiontop">
        <h2 className="skillsectiontitle">Front-end</h2>
        <p className="skillname">{skillnameFront}</p>
      </div>
      <p className="skillsetdesc">
        Front-end development was my starting point on my journey as a
        developer, and it remains the area where I feel most familiar. Beginning
        with HTML, CSS, and JavaScript, I built simple applications using these
        foundational technologies before delving into the more refined approach
        of React. As I progressed, my comfort with JSX grew significantly and
        I've grown profoundly more accustomed to the framework, creating
        websites both entirely front-end, as well as integrating server-side
        APIs into my projects also.
      </p>
      {frontendSkillsSet}
      <div class="skillsectiontop">
        <h2 className="skillsectiontitle">Back-end</h2>
        <p className="skillname">{skillnameBack}</p>
      </div>
      <p className="skillsetdesc">
        Learning to be a full-stack developer has been incredibly rewarding. I
        began by mastering Node.js and its accompanying framework, Express. With
        this knowledge, I can now create straightforward and refreshing APIs for
        server-side code, adhering to standard RESTful practices. My confidence
        extends to leveraging my front-end expertise in conjunction with my
        back-end services. Moreover, if required, I am adept at using templating
        engines like Pug to maintain a clean and structured MVC architecture.
      </p>
      {backendSkillsSet}
      <div class="skillsectiontop">
        <h2 className="skillsectiontitle">Other</h2>
        <p className="skillname">{skillnameOther}</p>
      </div>
      <p className="skillsetdesc">
        Throughout my learning journey, I have come to appreciate various tools
        in web development, and among them, using a version control system has
        been particularly significant; nothing is as reassuring and
        indispensable as Git in managing my code. Additionally, graduating from
        university with a degree in graphic design has provided me with ample
        opportunities to familiarize myself with design software, with Adobe
        Creative Cloud being a predominant part of my toolkit. I am proficient
        in using applications like Photoshop, Illustrator, and After Effects,
        all of which have enriched my capabilities in the aspect of design.
      </p>
      {otherSkillsSet}
      ...
      <div className="currentlyworkingoncontainer">
        <div class="cwoleft">
            ...
            <p className="currentlyworkingondesc">
              As technologies continue to evolve, I'm a firm believer that there
              will <i>always</i> be something to learn. I'm currently working
              towards educating myself further on back-end development, therefore,
              advancing my knowledge in PHP and Laravel. I already have a solid
              understanding of server-side code from my experience with Node and
              Express, and with PHP being incredibly desirable and popular even
              today, I can't continue to progress without having it under my
              skillset.
            </p>
        </div>
        <div class="cworight">
            ...
            <div className="slideshowarea">
              ...
              <div className="slideshow">
                <a
                  href={currentlyWorkingOnArray[0].website}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="slideshowimagecontainer"
                >
