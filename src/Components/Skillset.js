...
const Skillset = () => {
    ...
    const frontendSkillsSet = deviceWidth <= 600 ? 
    <div className="skillscontainer">
        <a href="https://www.javascript.com/" target="_blank" rel="noopener noreferrer"><img className="skillsetlogo javascript" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" onMouseOver={changeSkillNameFront} alt="JavaScript"/></a>
    
        <a href="https://www.w3schools.com/html/" target="_blank" rel="noopener noreferrer"><img className="skillsetlogo html" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg" onMouseOver={changeSkillNameFront} alt="HTML"/></a>
...
const backendSkillsSet = deviceWidth <= 600 ? 
    <div className="skillscontainer">
        <a href="https://nodejs.org/en" target="_blank" rel="noopener noreferrer"><img className="skillsetlogo node" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg" onMouseOver={changeSkillNameBack} alt="NodeJS"/></a>
...
const otherSkillsSet = deviceWidth <= 600 ? 
    <div className="skillscontainer">
        <a href="https://git-scm.com/" target="_blank" rel="noopener noreferrer"><img className="skillsetlogo git" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg" onMouseOver={changeSkillNameOther} alt="Git"/></a>

        <a href="https://webpack.js.org/" target="_blank" rel="noopener noreferrer"><img className="skillsetlogo webpack" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/webpack/webpack-original.svg" onMouseOver={changeSkillNameOther} alt="Webpack"/></a>

        <a href="https://jestjs.io/" target="_blank" rel="noopener noreferrer"><img className="skillsetlogo jest" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jest/jest-plain.svg" onMouseOver={changeSkillNameOther} alt="Jest"/></a>

        <a href="https://www.adobe.com/uk/products/photoshop.html" target="_blank" rel="noopener noreferrer"><img className="skillsetlogo photoshop" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/photoshop/photoshop-line.svg" onMouseOver={changeSkillNameOther} alt="Adobe Photoshop"/></a>

        <a href="https://www.adobe.com/uk/products/illustrator.html" target="_blank" rel="noopener noreferrer"><img className="skillsetlogo illustrator" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/illustrator/illustrator-line.svg" onMouseOver={changeSkillNameOther} alt="Adobe Illustrator"/></a>

        <a href="https://www.adobe.com/uk/products/aftereffects.html" target="_blank" rel="noopener noreferrer"><img className="skillsetlogo aftereffects" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/aftereffects/aftereffects-original.svg" onMouseOver={changeSkillNameOther} alt="Adobe After Effects" /></a>
    ...
    return (
        <div className="Skillset">
            ...
            <p className="skillsetdescmain">Throughout the course of my studying and independent research, I've come across many core technologies of web development, the majority of which are shown below.</p>
